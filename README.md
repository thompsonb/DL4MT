...
Test the build: ./run_tests.py

To train language models: nematus/train_LMs.py

To run: ./run_train_dual.py

I'm developing on the bleeding edge Theano (Theano-0.9.0.dev4 as of 20161227), using this python (2.7):
/home/.../anaconda/envs/theano_bleeding/bin/python

created via:

conda create --name theano_bleeding python=2
...
TODO (as of 20161228): "CNMeM is disabled" https://github.com/fchollet/keras/issues/987. More general... check/improve theano, Cuda, CUDNN, etc versions!

-------
todo: Use correct version of glibc for kenlm (based on instructions here: http://stackoverflow.com/questions/33655731/error-while-importing-tensorflow-in-python2-7-in-ubuntu-12-04-glibc-2-17-not-f/33658956#33658956)
...
LD_LIBRARY_PATH=/path-to-current-directory/libc6_2.17/lib/x86_64-linux-gnu/ /path-to-current-directory/libc6_2.17/lib/x86_64-linux-gnu/ld-2.17.so ~/anaconda/envs/theano_bleeding/bin/python
